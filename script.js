...
const translations = {
    en: {
        ...
        info_title: "Contact Information", contact_location: "Bishkek, Kyrgyzstan", nav_partners: "Official Universities", uni_ala: "Ala-Too International University", uni_paragon: "Paragon International University (Cambodia)",
    ...
    ru: {
        ...
        info_title: "Контактная информация", contact_location: "Бишкек, Кыргызстан", nav_partners: "Официальные Университеты", uni_ala: "Международный Университет Ала-Тоо", uni_paragon: "Международный Университет Paragon (Камбоджа)",
    ...
    ky: {
        ...
        info_title: "Байланыш Маалыматы", contact_location: "Бишкек, Кыргызстан", nav_partners: "Расмий Университеттер", uni_ala: "Ала-Тоо Эл аралык Университети", uni_paragon: "Paragon Эл аралык Университети (Камбоджа)",
    ...
    km: {
        ...
        about_desc_3: "<strong>পាក្សានៃការប្រើប្រាស់:</strong> អនុញ្ញាត给នឹងការពិនិត្យមើលដោយសុវត្ថិភាព។",
        about_desc_4: "<strong>ដំណើរការប្រសើរឡີ່:</strong> ធានា​សຳ​ລັບ​ການ​ຮັກສາ​ການ​ເຄຶ່ອນໄຫວ 1:1 ທີ່ໃຫ້ມີການຮັກສາທີ່ສູງຂຶ້ນຈາກ 75%.",
